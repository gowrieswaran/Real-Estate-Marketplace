...
contract Ownable {
    ...
    //  4) fill out the transferOwnership function
     ...
     function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0),"New owner does not hold real address");
        _owner = newOwner;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        require(owner != address(0),"Token balance not applicable!");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == owner || isApprovedForAll(owner,msg.sender),"Sender not allowed to access!!");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Address not owner of the token");
...
contract REMERC721Token is ERC721Metadata("GE's Real Estate Marketplace - Decentralized",
"GEREM","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
